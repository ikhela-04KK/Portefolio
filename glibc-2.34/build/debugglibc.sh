...
SOURCE_DIR="/workspaces/Portefolio/glibc-2.34"
BUILD_DIR="/workspaces/Portefolio/glibc-2.34/build/"
CMD_FILE="/workspaces/Portefolio/glibc-2.34/build/debugglibc.gdb"
CONTAINER=false
DIRECT=true
STATIC=false
SYMBOLSFILE=true
...
run --library-path /workspaces/Portefolio/glibc-2.34/build:/workspaces/Portefolio/glibc-2.34/build/math:/workspaces/Portefolio/glibc-2.34/build/elf:/workspaces/Portefolio/glibc-2.34/build/dlfcn:/workspaces/Portefolio/glibc-2.34/build/nss:/workspaces/Portefolio/glibc-2.34/build/nis:/workspaces/Portefolio/glibc-2.34/build/rt:/workspaces/Portefolio/glibc-2.34/build/resolv:/workspaces/Portefolio/glibc-2.34/build/mathvec:/workspaces/Portefolio/glibc-2.34/build/support:/workspaces/Portefolio/glibc-2.34/build/crypt:/workspaces/Portefolio/glibc-2.34/build/nptl:${BUILD_DIR}/nptl_db __COMMANDLINE__ __DIRECT__
__BREAKPOINTS__
EOF
}
...
WAIT_FOR_DEBUGGER=1 /workspaces/Portefolio/glibc-2.34/build/testrun.sh --tool=container ${TESTCASE} &
gdb -x ${TESTCASE}.gdb
elif [ "$STATIC" == true ]
then
gdb ${TESTCASE}
